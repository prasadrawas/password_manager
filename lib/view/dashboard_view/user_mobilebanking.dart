...
import 'package:password_manager/view/details_section/mobilebanking_details.dart';

class UserMobileBanking extends StatelessWidget {
  String _query = '';
  ...
  getDataFromDatabase() async {
    ...
    var response = await helper.fetchMobileBanking();
