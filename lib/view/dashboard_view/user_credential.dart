...
import 'package:password_manager/view/details_section/password_detail.dart';

class UserCredential extends StatelessWidget {
  String _query = '';
  ...
  getDataFromDatabase() async {
    ...
    var response = await helper.fetchCredentials();
    data = response;
    return data;
  }
  ...
  filterSearchResults() async {
    ...
    for (Map<String, dynamic> entry in data) {
      if (entry['title'].toLowerCase().contains(_query.toLowerCase())) {
